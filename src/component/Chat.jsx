    ...
    <div class="back-container">
      ...
      <div class="container front-container1">
        <div class="row chat-top">
          ...
          <div class="col-sm-8">
            <img src="images/image1.webp" alt="" class="profile-image rounded-circle" />
            <span class="ml-2">Gutka</span>
            <span class="float-right mt-2">
          ...
          <div class="col-sm-4 contacts">
            <div class="contact-table-scroll">
              <table class="table table-hover">
                <tbody>
                  <tr>
                    <td><img src="images/image1.webp" alt="" class="profile-image rounded-circle" /></td>
                    <td>Ruchika<br /> <small>achi chal rahi</small></td>
